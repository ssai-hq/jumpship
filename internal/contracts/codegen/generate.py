...
def render_compatibility_artifacts(
    ...
    baseline = {
        ...
        "policy": "Existing assertions, operations, component definitions, protobuf field numbers, enum values, and RPC methods are immutable in v1; optional additions are permitted.",
